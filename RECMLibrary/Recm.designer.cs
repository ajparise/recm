...
namespace Parise.RaisersEdge.ConnectionMonitor.Data
{
    ...
    partial void InsertLoginAudit(Parise.RaisersEdge.ConnectionMonitor.Data.Entities.LoginAudit instance);
    partial void UpdateLoginAudit(Parise.RaisersEdge.ConnectionMonitor.Data.Entities.LoginAudit instance);
    partial void DeleteLoginAudit(Parise.RaisersEdge.ConnectionMonitor.Data.Entities.LoginAudit instance);
    #endregion
		...
		public System.Data.Linq.Table<Parise.RaisersEdge.ConnectionMonitor.Data.Entities.LoginAudit> LoginAudits
		{
			get
			{
				return this.GetTable<Parise.RaisersEdge.ConnectionMonitor.Data.Entities.LoginAudit>();
			}
		}
	}
}
namespace Parise.RaisersEdge.ConnectionMonitor.Data.Entities
{
	...
	public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<LoginAudit> _LoginAudits;
    ...
    partial void OnUseWindowsAuthenticationChanged();
		...
		[Association(Name="User_LoginAudit", Storage="_LoginAudits", ThisKey="ID", OtherKey="UserID")]
		[DataMember(Order=9, EmitDefaultValue=false)]
		public EntitySet<LoginAudit> LoginAudits
		{
			get
			{
				if ((this.serializing 
							&& (this._LoginAudits.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
				return this._LoginAudits;
			}
			set
			{
				this._LoginAudits.Assign(value);
			}
		}
		...
		private void attach_LoginAudits(LoginAudit entity)
		{
			this.SendPropertyChanging();
			entity.User = this;
		}
		
		private void detach_LoginAudits(LoginAudit entity)
		{
			this.SendPropertyChanging();
			entity.User = null;
		}
		...
		{
			this._LoginAudits = new EntitySet<LoginAudit>(new Action<LoginAudit>(this.attach_LoginAudits), new Action<LoginAudit>(this.detach_LoginAudits));
			OnCreated();
		}
	...
	[Table(Name="dbo.LOGINAUDIT")]
	[DataContract()]
	public partial class LoginAudit : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnLogoutTimeChanged();
		...
		[Column(Name="LOGINCONNECTIONID", Storage="_ID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		[DataMember(Order=1)]
		public int ID
		{
			get
		...
		[Column(Name="MACHINENAME", Storage="_HostName", DbType="VarChar(100) NOT NULL", CanBeNull=false)]
		[DataMember(Order=2)]
		public string HostName
		{
			get
		...
		[Column(Name="USER_NAME", Storage="_UserName", DbType="VarChar(50)")]
		[DataMember(Order=4)]
		...
		[Column(Name="LOGOUT_TIME", Storage="_LogoutTime", DbType="DateTime")]
		[DataMember(Order=8)]
		...
		[Association(Name="User_LoginAudit", Storage="_User", ThisKey="UserID", OtherKey="ID", IsForeignKey=true)]
		public User User
		{
			get
			{
			...
			set
			{
							...
							|| (this._User.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.LoginAudits.Remove(this);
					}
					this._User.Entity = value;
					if ((value != null))
					{
						value.LoginAudits.Add(this);
